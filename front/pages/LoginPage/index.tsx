import React, {
  useState, useCallback, FunctionComponent, useEffect,
} from 'react';
...
import {
  ErrorDivWrapper, FormDivWrapper, FormWrapper, OperationDivWrapper,
} from './styles';
...
const LoginPage: FunctionComponent = () => {
  ...
  const onSubmitUserLogin = useCallback(
