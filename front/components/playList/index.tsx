...
const PlayListComp: FunctionComponent<PropType> = ({
  data,
  clickAddVideoList,
  clickDeletePlayList,
  clickDeleteVideo,
...
&nbsp;
        ...
        <ListOperatorDivWrapper>
          <StyledButton className="primary" onClick={onClickAddVideoListButton}>
            동영상 추가
          </StyledButton>
          <StyledButton className="danger" onClick={onClickDeleteListButton}>
            목록 삭제
          </StyledButton>
        </ListOperatorDivWrapper>
      </ListControlDivWrapper>
