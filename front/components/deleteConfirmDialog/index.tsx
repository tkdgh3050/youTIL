...
const DeleteConfirmDialog: FunctionComponent<{
  deleteConfirmDialogRef: React.RefObject<HTMLDialogElement>;
  flag: DeleteFlag;
  id: number[];
  name: string;
}> = ({
  deleteConfirmDialogRef, flag, id, name,
}) => {
    ...
    <DialogWrapper ref={deleteConfirmDialogRef}>
      <DialogConfirmWrapper>
        ...
        <DialogMenuWrapper>
          ...
          <StyledButton className="danger" type="button" onClick={onClickDeleteConfirm}>
            삭제
          </StyledButton>
        </DialogMenuWrapper>
      </DialogConfirmWrapper>
